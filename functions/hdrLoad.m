...
% downloaded from matworks-site, not part of the Ecgtool project.

% HDRLOAD Load data from an ASCII file containing a header.
%     [header, data] = HDRLOAD('filename.ext') reads a data file
%     called 'filename.ext', which contains a header.  There
...
while isempty(data)|(nxtindex==1)
	...
	% Create unique variable to hold this line of tarkasteluvali_text information.
